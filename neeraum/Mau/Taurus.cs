...
namespace Mau
{
    public partial class Taurus : Form
    {
        ...
        private void display()
        {
            ...
            string query = "SELECT * FROM Taurus";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = @"INSERT INTO Taurus (TransactionID, TireTypeID, Tire, Price, Stocks, Sold)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string updateQuery = @"UPDATE Taurus
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string deleteQuery = @"DELETE FROM Taurus
                       WHERE TransactionID = @TransactionID";
