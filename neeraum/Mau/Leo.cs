...
namespace Mau
{
    public partial class Leo : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = @"INSERT INTO LeoLaseer (TransactionID, TireTypeID, Tire, Price, Stocks, Sold)
        ...
        private void display()
        {
            ...
            string connectionString = "Data Source=DESKTOP-C75ROGV\\SQLEXPRESS;Initial Catalog=maureen;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
            string query = "SELECT * FROM LeoLaseer";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string updateQuery = @"UPDATE LeoLaseer 
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string deleteQuery = @"DELETE FROM LeoLaseer 
                       WHERE TransactionID = @TransactionID";
