...
namespace Mau
{
    public partial class SonyFront : Form
    {
        public SonyFront()
        {
            InitializeComponent();
        ...
        private void display()
        {
            ...
            string query = "SELECT * FROM SonyFront";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = @"INSERT INTO SonyFront (TransactionID, TireTypeID, Tire, Price, Stocks, Sold)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string updateQuery = @"UPDATE SonyFront
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string deleteQuery = @"DELETE FROM SonyFront
                       WHERE TransactionID = @TransactionID";
